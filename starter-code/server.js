...
const app = express();
const conString = 'postgres://postgres:postgres@localhost:5432/postgres';// TODO: Don't forget to set your own conString
...
app.get('/articles', function(request, response) {
  ...
  client.query(`SELECT * FROM article JOIN on article.author_id=authors.author_id`)
...
app.post('/articles', function(request, response) {
  ...
  client.query('INSERT INTO authors (author, authorURL) VALUES ($1, $2) ON CONFLICT DO NOTHING;',
  ...
  .then(function() {
    ...
    client.query('INSERT INTO articles (author_id, title, category, publishedOn, body) VALUES ((SELECT author_id FROM authors  WHERE author = $1), $2, $3, $4, $5) ON CONFLICT DO NOTHING;',    
      [request.body.author, request.body.title, request.body.category, request.body.publishedOn, request.body.body]
    )
  })
  .then(function() {
...
app.put('/articles/:id', function(request, response) {
  ...
  // TODO: Add the required values from the request as data for the SQL query to interpolate
  client.query(`UPDATE authors SET author= $1, authorUrl = $2 WHERE author_id=$3` 
  ...
  .then(function() {
    ...
    // TODO: Add the required values from the request as data for the SQL query to interpolate
    client.query(`UPDATE articles SET title=$1, category=$2, publishedOn=$3, body=$4, author_id=$5 WHERE article_id= $6`,
