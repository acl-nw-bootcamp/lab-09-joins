...
const app = express();
const conString = 'postgres://nickhoszko@localhost:5432/nickhoszko';   // TODO: Don\'t forget to set your own conString
...
app.get('/articles', function(request, response) {                      //ATTEMPTED
...
app.post('/articles', function(request, response) {                 // ATTEMPTED
...
app.put('/articles/:id', function(request, response) {            // ATTEMPTED
